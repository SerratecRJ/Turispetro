...
public class ClientResource {
	...
	public ResponseEntity<Page<ClientDTO>> findByName(
		...
		Page<ClientDTO> list = clientService.findByName(login, pageRequest);	
	...
	public ResponseEntity<ClientDTO> insert(@RequestBody ClientDTO client) {
		...
		URI uri = ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand(client.getUser_id()).toUri();
